...
import {
  ...
  CreateTestEndpointTestsPostRequest$zodSchema,
} from "../models/createtestendpointtestspostop.js";
 ...
 */
export function testsCreate(
  client$: CalibrateMcpCore,
  request: CreateTestEndpointTestsPostRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateTestEndpointTestsPostRequest$zodSchema.parse(value$),
