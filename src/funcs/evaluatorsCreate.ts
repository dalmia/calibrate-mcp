...
import {
  ...
  CreateEvaluatorEndpointEvaluatorsPostRequest$zodSchema,
} from "../models/createevaluatorendpointevaluatorspostop.js";
 ...
 */
export function evaluatorsCreate(
  client$: CalibrateMcpCore,
  request: CreateEvaluatorEndpointEvaluatorsPostRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      CreateEvaluatorEndpointEvaluatorsPostRequest$zodSchema.parse(value$),
