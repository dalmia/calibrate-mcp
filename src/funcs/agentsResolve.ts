...
import {
  ...
  ResolveAgentNamesAgentsResolvePostRequest$zodSchema,
 ...
 */
export function agentsResolve(
  client$: CalibrateMcpCore,
  request: ResolveAgentNamesAgentsResolvePostRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      ResolveAgentNamesAgentsResolvePostRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/agents/resolve")();
