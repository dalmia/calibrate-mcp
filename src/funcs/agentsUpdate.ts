...
import {
  ...
  UpdateAgentEndpointAgentsAgentUuidPutRequest$zodSchema,
} from "../models/updateagentendpointagentsagentuuidputop.js";
...
export function agentsUpdate(
  ...
  request: UpdateAgentEndpointAgentsAgentUuidPutRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      UpdateAgentEndpointAgentsAgentUuidPutRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/agents/{agent_uuid}")(
    pathParams$,
  );
