...
import {
  ...
  ListTestsTestsGetRequest$zodSchema,
} from "../models/listteststestsgetop.js";
...
export function testsList(
  ...
  request?: ListTestsTestsGetRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListTestsTestsGetRequest$zodSchema.optional().parse(value$),
