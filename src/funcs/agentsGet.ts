...
import {
  ...
  GetAgentEndpointAgentsAgentUuidGetRequest$zodSchema,
} from "../models/getagentendpointagentsagentuuidgetop.js";
...
export function agentsGet(
  ...
  request: GetAgentEndpointAgentsAgentUuidGetRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetAgentEndpointAgentsAgentUuidGetRequest$zodSchema.parse(value$),
