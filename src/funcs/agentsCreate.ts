...
import {
  ...
  CreateAgentEndpointAgentsPostRequest$zodSchema,
} from "../models/createagentendpointagentspostop.js";
...
export function agentsCreate(
  ...
  request: CreateAgentEndpointAgentsPostRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateAgentEndpointAgentsPostRequest$zodSchema.parse(value$),
