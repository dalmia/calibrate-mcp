...
import {
  ...
  ListAgentsAgentsGetRequest$zodSchema,
} from "../models/listagentsagentsgetop.js";
...
export function agentsList(
  ...
  request?: ListAgentsAgentsGetRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListAgentsAgentsGetRequest$zodSchema.optional().parse(value$),
