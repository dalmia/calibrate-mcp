...
import {
  ...
  ListAnnotationTasksAnnotationTasksGetRequest$zodSchema,
} from "../models/listannotationtasksannotationtasksgetop.js";
 ...
 */
export function annotationTasksList(
  client$: CalibrateMcpCore,
  request?: ListAnnotationTasksAnnotationTasksGetRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      ListAnnotationTasksAnnotationTasksGetRequest$zodSchema.optional().parse(
        value$,
      ),
