...
import {
  ...
  GetAgentTestRunStatusAgentTestsRunTaskIdGetRequest$zodSchema,
} from "../models/getagenttestrunstatusagenttestsruntaskidgetop.js";
...
export function agentTestsGetRun(
  ...
  request: GetAgentTestRunStatusAgentTestsRunTaskIdGetRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetAgentTestRunStatusAgentTestsRunTaskIdGetRequest$zodSchema.parse(
        value$,
      ),
