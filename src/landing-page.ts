...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "env": { "API_KEY_AUTH": "YOUR_VALUE_HERE" },
  };
  const codexConfig = `[mcp_servers.CalibrateMcp]
url = "${o}/sse"
http_headers = { "api-key-auth" = "YOUR_API_KEY_AUTH" }`;
...
<head>
    ...
    <title>@dalmia/calibrate-mcp MCP</title>
    <meta name="description" content="Install @dalmia/calibrate-mcp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@dalmia/calibrate-mcp - MCP Server">
    <meta property="og:description" content="Install @dalmia/calibrate-mcp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@dalmia/calibrate-mcp - MCP Server">
    <meta property="twitter:description" content="Install @dalmia/calibrate-mcp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@dalmia/calibrate-mcp</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=CalibrateMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAZGFsbWlhL2NhbGlicmF0ZS1tY3AiLCJzdGFydCIsIi0tYXBpLWtleS1hdXRoIiwiIl19">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=CalibrateMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAZGFsbWlhL2NhbGlicmF0ZS1tY3AiLCJzdGFydCIsIi0tYXBpLWtleS1hdXRoIiwiIl19">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=CalibrateMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAZGFsbWlhL2NhbGlicmF0ZS1tY3AiLCJzdGFydCIsIi0tYXBpLWtleS1hdXRoIiwiIl19">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=CalibrateMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAZGFsbWlhL2NhbGlicmF0ZS1tY3AiLCJzdGFydCIsIi0tYXBpLWtleS1hdXRoIiwiIl19">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add CalibrateMcp -- npx -y @dalmia/calibrate-mcp start --api-key-auth </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/dalmia/calibrate-mcp/releases/download/v0.0.51/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add CalibrateMcp -- npx -y @dalmia/calibrate-mcp start --api-key-auth </code>
        </div>
      </div>
    </div>
