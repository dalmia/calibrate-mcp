    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/dalmia/calibrate-mcp/releases/download/v0.0.58/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
